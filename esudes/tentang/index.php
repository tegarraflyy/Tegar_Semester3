...
<body class="bg-light">
				...
				<div class="card-body">
					<div class="card-text">
						<p>
							...
							<hr>
						<blockquote>
							Web Aplikasi untuk pelayanan surat administrasi desa yang dikembangkan oleh <b><a href="https://www.instagram.com/tegarraplyy/" style="text-decoration:none">rajikhbfaj</a></b> untuk mempermudah staff pelayanan dan penduduk dalam pembuatan surat administrasi desa.
							<br>
							<br>
						</blockquote>
						</p>
					...
					<div class="row text-center">
						<div class="col-md-12">
							<img src="#" class="img-circle"><br><br>
							<p class="text-muted">Trademark By <b><a href="#" style="text-decoration:none">Tegar Rafly</a></b></p>
						</div>
	...
	<div class="footer bg-dark text-center">
		<span class="text-light"><strong>Copyright &copy; 2022 <a href="../" class="text-decoration-none text-white">e-SuratDesa</a>.</strong> All rights reserved.</span>
	</div>
</body>
