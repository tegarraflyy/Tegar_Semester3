...
<body>
	...
	<div class="container" style="max-height:cover; padding-top:50px; padding-bottom:120px" align="center">
		<img src="../siap-des-master/assets/img/logodesa.png" width="15%">
		<hr>
		<a class="text-light" style="font-size:18pt"><strong>WEBSITE PELAYANAN SURAT ADMINISTRASI DESA</strong></a><br>
		<?php
		...
		?>
			<a class="text-light" style="font-size:15pt; text-transform: uppercase;"><strong>DESA <?php echo $row['nama_desa']; ?></strong><br>
				<a class="text-light" style="font-size:15pt; text-transform: uppercase;"><strong><?php echo $row['kota']; ?></strong></a>
				<hr>
			<?php
		}
			?>
	...
	<div class="footer bg-transparent text-center mb-3 ">
		<span class="text-light"><strong>&copy; <a href="#" class="text-decoration-none text-white">e-SuratDesa</a>.</strong> .</span>
	</div>
</body>
