          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <h3>
                ...
                $qTampil = mysqli_query($connect, "SELECT jenis_surat FROM surat_keterangan WHERE status_surat='selesai'  UNION SELECT jenis_surat FROM surat_keterangan_domisili WHERE status_surat='selesai' UNION SELECT jenis_surat FROM surat_keterangan_usaha WHERE status_surat='selesai'");
                $jumlahPermintaanSurat = mysqli_num_rows($qTampil);
                echo $jumlahPermintaanSurat;
                ?>
              </h3>
              ...
              <form class="form-horizontal" method="post" action="simpan-penduduk.php">
                <div class="col-md-12">
                  <div class="col-md-4" style="text-align: center;">
                    <img style="max-width:300px; width:100%; height:auto;" src="../../assets/img/logodesa.png" width='15%'> <br>
                    <?php
                  ...
                  <div class="col-md-8">
                    ...
                    <div style="font-size: 15pt; font-weight: 500;">
                      <p>Selamat datang di <a href="#" style="text-decoration:none"><strong>Web Aplikasi Pelayanan Surat Administrasi Desa Suka Kamu.</strong></a></p>
                    </div><br><br><br>
                    <div style="font-size: 10pt; font-weight: 500;">© e-<b>SuratDesa</b> </div>
                  </div>
                </div>
              </form>
            </div>
