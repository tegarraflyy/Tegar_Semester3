...
<body class="bg-light">
		...
		<div style="max-height:cover; padding-top:30px; padding-bottom:60px; position:relative; min-height: 100%;">
			<div class="row">
				<div class="col-sm-3 mt-4">
					<div class="card">
						<img src="../assets/img/logodesa.png" width='15%' class="card-img-top" alt="...">
						<div class="card-body text-center">
							<h5 class="card-title">SURAT KTP SEMENTARA</h5><br><br>
				...
				<div class="col-sm-3 mt-4">
					<div class="card">
						<img src="../assets/img/logodesa.png" width='15%' class="card-img-top" alt="...">
						<div class="card-body text-center">
							<h5 class="card-title">SURAT KETERANGAN LAHIR</h5><br><br>
							<a href="surat_keterangan_lahir/" class="btn btn-info">BUAT SURAT</a>
						</div>
					</div>
				</div>
				<div class="col-sm-3 mt-4">
					<div class="card">
						<img src="../assets/img/logodesa.png" width='15%' class="card-img-top" alt="...">
						<div class="card-body text-center">
							<h5 class="card-title">SURAT PENGANTAR PINDAH</h5><br><br>
							<a href="surat_pengantar_pindah/" class="btn btn-info">BUAT SURAT</a>
						</div>
					</div>
				</div>
				<div class="col-sm-3 mt-4">
					<div class="card">
						<img src="../assets/img/logodesa.png" width='15%' class="card-img-top" alt="...">
						<div class="card-body text-center">
							<h5 class="card-title">SURAT KETERANGAN KEHILANGAN</h5><br><br>
	...
	<div class="footer bg-dark text-center">
		<span class="text-light"><strong>&copy; <a href="../" cla s="text-decoration-none text-white">e-SuratDesa</a>.</strong> All rights reserved.</span>
	</div>
</body>
